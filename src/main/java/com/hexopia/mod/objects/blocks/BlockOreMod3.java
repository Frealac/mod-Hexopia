...
public class BlockOreMod3 extends Block implements IHasModel
{
	
	public BlockOreMod3(String name, Material material) 
	{
		super(material);
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		...
		list.add(new ItemStack(BlockInit.ORE_DIARIUM));
		return list;
	}
}
