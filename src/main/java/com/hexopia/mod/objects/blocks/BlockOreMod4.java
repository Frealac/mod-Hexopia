...
public class BlockOreMod4 extends Block  implements IHasModel
{
	
	public BlockOreMod4(String name, Material material) 
	{
		super(material);
		...
		setHarvestLevel("pickaxe, hammer", 5);
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		...
		list.add(new ItemStack(ItemInit.ETIX));
		return list;
	}
}
