...
public class ArmorMod2 extends ItemArmor implements IHasModel
{

	public ArmorMod2(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
