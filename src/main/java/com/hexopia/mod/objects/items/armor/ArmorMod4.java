...
public class ArmorMod4 extends ItemArmor implements IHasModel
{

	public ArmorMod4(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
